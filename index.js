...
const memoryUsed = process.memoryUsage().heapUsed/1024/1024/1024;
...
function filterValue(find) {
    return listOfObj.filter((object) => {
        if(object.func == 'REMOVED' || object.func == 'CLEAN' || object.func == 'ERROR')
            return find == object["fileName"]
...
console.log(`xdnkhdekjhfnchekjcnhdnjhMMMMMMMMMMMMMMMMMMM ${times}` )
